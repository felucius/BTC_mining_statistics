...
public class CustomPoolListAdapter extends BaseExpandableListAdapter{
    ...
    public View getChildView(int listPosition, final int expandedListPosition,
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.pool_expandableitemview, null);
        }
        TextView expandedListTextView = (TextView) convertView
                .findViewById(R.id.txtBlockName);
    ...
    public View getGroupView(int listPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.pool_expandablelistview, null);
        }

        TextView listTitleTextView = (TextView) convertView.findViewById(R.id.txtBlockNumber);
